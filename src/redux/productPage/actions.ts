...
export const getRelatedProducts = () => (dispatch: Dispatch) => {
    dispatch(setProductsSpinner(true))
    axiosInstance
        .get(`http://localhost:5050/products?_start=9&_limit=4`)
        .then((response) => {
...
export const getFeaturedProduct = () => (dispatch: Dispatch) => {
    dispatch(setProductsSpinner(true))
    axiosInstance
        .get(`http://localhost:5050/products?_start=21&_limit=4`)
        .then((response) => {
...
export const getLatestProduct = () => (dispatch: Dispatch) => {
    dispatch(setProductsSpinner(true))
    axiosInstance
        .get(`http://localhost:5050/products?_start=25&_limit=8`)
        .then((response) => {
...
export const getExclusiveProduct = () => (dispatch: Dispatch) => {
    dispatch(setProductsSpinner(true))
    axiosInstance
        .get(`http://localhost:5050/products/25`)
        .then((response) => {
...
export const getQuotes = () => (dispatch: Dispatch) => {
    dispatch(setProductsSpinner(true))
    axiosInstance
        .get(`http://localhost:5050/quotes`)
        .then((response) => {
...
export const getSearchProduct = (search: string) => (dispatch: Dispatch) => {
    dispatch(setProductsSpinner(true))
    axiosInstance
        .get(`http://localhost:5050/products`, { params: { q: search } })
        .then((response) => {
